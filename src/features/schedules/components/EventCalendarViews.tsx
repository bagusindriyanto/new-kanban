                ...
                className={cn(
                  ...
                  textPart.type === 'day' && info.isToday
                    ? [
                        ...
                        info.hasNavLink &&
                          'group-hover:bg-chart-1/60 group-focus-visible:outline-3 outline-ring/50',
                      ]
        ...
        cn(
          ...
          !info.level && info.isToday
            ? [
                'bg-chart-1/50',
                info.hasNavLink &&
                  'hover:bg-chart-1/60 focus-visible:outline-3 outline-ring/50',
              ]
            : info.hasNavLink && 'hover:bg-foreground/5',
        )
      }
      ...
      views={{
        ...
        multiMonth: {
          ...
          tableHeaderClass: (info) =>
            cn(info.multiMonthColumns === 1 && 'bg-background'),
          dayHeaderAlign: (info) =>
            info.inPopover ? 'start' : info.isNarrow ? 'center' : 'end',
        ...
        list: {
          ...
          listItemEventClass: (info) =>
            cn(
              ...
              info.isInteractive &&
                'focus-visible:bg-muted/50 -outline-offset-3',
            ),
