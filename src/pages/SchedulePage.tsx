...
import EventCalendarViews from '@/features/schedules/components/EventCalendarViews';
import { demoEvents } from '@/features/schedules/constants/eventsData';
...
const SchedulePage = () => {
  ...
  const [selectedCalendar, setSelectedCalendar] = useState(calendars[0].value);
